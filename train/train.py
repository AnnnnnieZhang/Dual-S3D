...
from train.train_utils import load_device, get_model, get_loss, \
    get_dataloader,CheckpointIO,get_trainer,get_optimizer,load_scheduler
from utils.model_utils.net_utils import fix_random_seed
...
def parse_args():
    '''PARAMETERS'''
    parser = argparse.ArgumentParser('diffu3Dmodel training')
